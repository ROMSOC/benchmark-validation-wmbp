##############################################################################
#
# CMake variable for use by LifeV/Core clients. 
#
...
## ---------------------------------------------------------------------------
## Compilers used by LifeV/Core build
## ---------------------------------------------------------------------------
...
SET(Core_FORTRAN_COMPILER "mpif90")


## ---------------------------------------------------------------------------
## Compiler flags used by LifeV/Core build
## ---------------------------------------------------------------------------

## Set compiler flags, including those determined by build type
SET(Core_CXX_FLAGS " -pedantic -Wall -Wno-long-long -Wwrite-strings  -DTRILIBRARY -DTETLIBRARY -std=c++11 -O3 -msse3 -Wno-unused-local-typedefs -Wno-literal-suffix -Wno-cpp -Wunused-parameter -O3")

SET(Core_C_FLAGS " -pedantic -Wall -Wno-long-long  -DTRILIBRARY -DTETLIBRARY -std=c++11 -O3 -msse3 -O3")

SET(Core_FORTRAN_FLAGS " ")
...
SET(Core_BUILD_SHARED_LIBS "OFF")
...
SET(Core_PACKAGE_LIST "Core")

## The TPLs enabled for this project
SET(Core_TPL_LIST "Trilinos;Triangle;TetGen;HDF5;ParMETIS;Boost;LAPACK;BLAS;MPI")
