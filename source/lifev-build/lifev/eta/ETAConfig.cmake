##############################################################################
#
# CMake variable for use by LifeV/ETA clients. 
#
...
## ---------------------------------------------------------------------------
## Compilers used by LifeV/ETA build
## ---------------------------------------------------------------------------

SET(ETA_CXX_COMPILER "/usr/bin/mpicxx")

SET(ETA_C_COMPILER "/usr/bin/mpicc")

SET(ETA_FORTRAN_COMPILER "mpif90")


## ---------------------------------------------------------------------------
## Compiler flags used by LifeV/ETA build
## ---------------------------------------------------------------------------

## Set compiler flags, including those determined by build type
SET(ETA_CXX_FLAGS " -pedantic -Wall -Wno-long-long -Wwrite-strings  -DTRILIBRARY -DTETLIBRARY -std=c++11 -O3 -msse3 -Wno-unused-local-typedefs -Wno-literal-suffix -Wno-cpp -Wunused-parameter -O3")

SET(ETA_C_FLAGS " -pedantic -Wall -Wno-long-long  -DTRILIBRARY -DTETLIBRARY -std=c++11 -O3 -msse3 -O3")

SET(ETA_FORTRAN_FLAGS " ")

## Extra link flags (e.g., specification of fortran libraries)
SET(ETA_EXTRA_LD_FLAGS "")

## This is the command-line entry used for setting rpaths. In a build
## with static libraries it will be empty. 
SET(ETA_SHARED_LIB_RPATH_COMMAND "")
SET(ETA_BUILD_SHARED_LIBS "OFF")

SET(ETA_LINKER /usr/bin/ld)
SET(ETA_AR ar)
...
SET(ETA_MPI_LIBRARIES "")
SET(ETA_MPI_LIBRARY_DIRS "")
SET(ETA_MPI_INCLUDE_DIRS "")
SET(ETA_MPI_EXEC "/usr/bin/mpiexec")
SET(ETA_MPI_EXEC_MAX_NUMPROCS "4")
SET(ETA_MPI_EXEC_NUMPROCS_FLAG "-np")
...
SET(ETA_PACKAGE_LIST "ETA;Core")

## The TPLs enabled for this project
SET(ETA_TPL_LIST "Trilinos;Triangle;TetGen;HDF5;ParMETIS;Boost;LAPACK;BLAS;MPI")
